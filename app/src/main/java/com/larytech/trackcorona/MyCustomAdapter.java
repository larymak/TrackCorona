...
public class MyCustomAdapter extends ArrayAdapter<CountryModel> {
    ...
    public MyCustomAdapter(Context context, List<CountryModel> countryModelList) {
        super(context, R.layout.list_custom_layout, countryModelList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_custom_layout, null,true);
